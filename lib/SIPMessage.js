...
var getSupportedHeader = function (request) {
    ...
    optionTags = optionTags.filter(function (optionTag) {
        var registered = C.OPTION_TAGS[optionTag];
...
var OutgoingRequest = /** @class */ (function () {
    function OutgoingRequest(method, ruri, ua, params, extraHeaders, body) {
        ...
        to += "<" + (toUri.type === TypeStrings.URI ? toUri.toRaw() : toUri) + ">";
        ...
        from += "<" + (fromUri.type === TypeStrings.URI ? fromUri.toRaw() : fromUri) + ">;tag=";
    ...
    OutgoingRequest.prototype.getHeaders = function (name) {
        var result = [];
        var headerArray = this.headers[Utils.headerize(name)];
        if (headerArray) {
    ...
    OutgoingRequest.prototype.toString = function () {
        var msg = "";
        msg += this.method + " " + (this.ruri.type === TypeStrings.URI ?
            this.ruri.toRaw() : this.ruri) + " SIP/2.0\r\n";
        for (var _i = 0, _a = this.headers; _i < _a.length; _i++) {
            var header = _a[_i];
            for (var _b = 0, header_1 = header; _b < header_1.length; _b++) {
                var headerPart = header_1[_b];
                msg += header + ": " + headerPart + "\r\n";
            }
        }
        for (var _c = 0, _d = this.extraHeaders; _c < _d.length; _c++) {
            var header = _d[_c];
            msg += header.trim() + "\r\n";
        }
...
var IncomingMessage = /** @class */ (function () {
    function IncomingMessage() {
        this.type = TypeStrings.IncomingMessage;
        this.headers = {};
    }
    /**
...
var IncomingRequest = /** @class */ (function (_super) {
    ...
    function IncomingRequest(ua) {
        ...
        _this.type = TypeStrings.IncomingRequest;
    ...
    IncomingRequest.prototype.reply = function (code, reason, extraHeaders, body, onSuccess, onFailure) {
        var response = Utils.buildStatusLine(code, reason);
...
var IncomingResponse = /** @class */ (function (_super) {
    ...
    function IncomingResponse(ua) {
        var _this = _super.call(this) || this;
        _this.type = TypeStrings.IncomingResponse;
        _this.logger = ua.getLogger("sip.sipmessage");
        _this.headers = {};
        return _this;
    }

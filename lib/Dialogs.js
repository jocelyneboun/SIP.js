...
var Dialog = /** @class */ (function () {
    ...
    Dialog.prototype.createRequest = function (method, extraHeaders, body) {
        ...
        var cseq = (method === C.CANCEL || method === C.ACK) ? this.inviteSeqnum : this.localSeqnum += 1;
        var request = new OutgoingRequest(method, this.remoteTarget, this.owner.ua, {
            cseq: cseq,

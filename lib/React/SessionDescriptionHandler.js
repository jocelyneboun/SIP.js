...
import { getUserMedia, MediaStream, RTCPeerConnection, } from "react-native-webrtc";
...
var SessionDescriptionHandler = /** @class */ (function (_super) {
    ...
    function SessionDescriptionHandler(logger, observer, options) {
        ...
        _this.type = TypeStrings.SessionDescriptionHandler;
    ...
    SessionDescriptionHandler.prototype.getDescription = function (options, modifiers) {
        ...
        return Promise.resolve().then(function () {
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("createOffer failed", e);
    ...
    SessionDescriptionHandler.prototype.setDescription = function (sessionDescription, options, modifiers) {
        ...
        return Promise.resolve().then(function () {
        ...
        }).then(function () { return Utils.reducePromises(modifiers, description); })
            .catch(function (e) {
            if (e.type === TypeStrings.SessionDescriptionHandlerError) {
                throw e;
            }
            var error = new Exceptions.SessionDescriptionHandlerError("setDescription", e, "The modifiers did not resolve successfully");
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("setDescription", e);
            if (error.error) {
    ...
    SessionDescriptionHandler.prototype.createOfferOrAnswer = function (RTCOfferOptions, modifiers) {
        ...
        return pc[methodName](RTCOfferOptions).catch(function (e) {
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("createOfferOrAnswer", e, "peerConnection-" + methodName + "Failed");
            _this.emit("peerConnection-" + methodName + "Failed", error);
            throw error;
        }).then(function (sdp) { return Utils.reducePromises(modifiers, _this.createRTCSessionDescriptionInit(sdp)); })
            .then(function (sdp) {
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("createOfferOrAnswer", e, "peerConnection-SetLocalDescriptionFailed");
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("createOfferOrAnswer", e);
            _this.logger.error(error.toString());
            throw error;
        });
    };
    ...
    SessionDescriptionHandler.prototype.acquire = function (constraints) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("acquire", e, "unable to acquire streams");
            _this.logger.error(error.message);
            if (error.error) {
                _this.logger.error(error.error);
            }
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("acquire", e, "error removing streams");
            _this.logger.error(error.message);
            if (error.error) {
                _this.logger.error(error.error);
            }
            ...
            var error = new Exceptions.SessionDescriptionHandlerError("acquire", e, "error adding stream");
            _this.logger.error(error.message);
            if (error.error) {
                _this.logger.error(error.error);
            }
...
export { SessionDescriptionHandler };

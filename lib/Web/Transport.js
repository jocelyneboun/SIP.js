...
var Transport = /** @class */ (function (_super) {
    ...
    function Transport(logger, options) {
        ...
        _this.type = TypeStrings.Transport;
    ...
    Transport.prototype.connectPromise = function (options) {
        ...
        this.connectionPromise = new Promise(function (resolve, reject) {
            ...
            _this.ws.addEventListener("open", _this.onOpen.bind(_this));
            _this.ws.addEventListener("message", _this.onMessage.bind(_this));
            _this.ws.addEventListener("close", _this.onClose.bind(_this));
            _this.ws.addEventListener("error", _this.onWebsocketError.bind(_this));
        });
        return this.connectionPromise;
    };
    /**
            ...
            optional: {
                ...
                wsServers: function (wsServers) {
                    ...
                    for (var _i = 0, wsServers_1 = wsServers; _i < wsServers_1.length; _i++) {
                        ...
                        var url = Grammar.parse(wsServer.wsUri, "absoluteURI");
                        if (url === -1) {
                            return;
                        }

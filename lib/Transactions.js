...
var NonInviteClientTransaction = /** @class */ (function (_super) {
    ...
    function NonInviteClientTransaction(requestSender, request, transport) {
        ...
        _this.type = TypeStrings.NonInviteClientTransaction;
...
export { NonInviteClientTransaction };
/**
...
var InviteClientTransaction = /** @class */ (function (_super) {
    ...
    function InviteClientTransaction(requestSender, request, transport) {
        ...
        _this.type = TypeStrings.InviteClientTransaction;
        _this.transport = transport;
        _this.id = "z9hG4bK" + Math.floor(Math.random() * 10000000);
        _this.requestSender = requestSender;
        _this.request = request;
    ...
    InviteClientTransaction.prototype.sendACK = function (options) {
        ...
        if (this.response) {
            var ack = new OutgoingRequest("ACK", ruri.toString(), this.request.ua, {
...
var AckClientTransaction = /** @class */ (function (_super) {
    ...
    function AckClientTransaction(requestSender, request, transport) {
        var _this = _super.call(this) || this;
        _this.type = TypeStrings.AckClientTransaction;
        _this.transport = transport;
        _this.id = "z9hG4bK" + Math.floor(Math.random() * 10000000);
        _this.requestSender = requestSender;
        _this.request = request;
...
var NonInviteServerTransaction = /** @class */ (function (_super) {
    ...
    function NonInviteServerTransaction(request, ua) {
        ...
        _this.type = TypeStrings.NonInviteServerTransaction;
        ...
        _this.state = TransactionStatus.STATUS_TRYING;
...
export { NonInviteServerTransaction };
/**
...
var InviteServerTransaction = /** @class */ (function (_super) {
    ...
    function InviteServerTransaction(request, ua) {
        ...
        _this.type = TypeStrings.InviteServerTransaction;
        _this.id = request.viaBranch;
        _this.request = request;
        _this.transport = ua.transport;
        _this.ua = ua;
        ...
        _this.state = TransactionStatus.STATUS_PROCEEDING;
        ua.newTransaction(_this);
        request.reply(100);
        return _this;
    }
    ...
    InviteServerTransaction.prototype.receiveResponse = function (statusCode, response) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (statusCode >= 100 && statusCode <= 199 && _this.state === TransactionStatus.STATUS_PROCEEDING) {
                ...
                switch (_this.state) {
                    case TransactionStatus.STATUS_PROCEEDING:
                        ...
                        _this.lastResponse = response;
                        _this.L = setTimeout(_this.timer_L.bind(_this), Timers.TIMER_L);
                        if (_this.resendProvisionalTimer !== undefined) {
                    ...
                    case TransactionStatus.STATUS_PROCEEDING:
                        ...
                        if (_this.transport) {
                            _this.transport.send(response).then(function () {
                                _this.stateChanged(TransactionStatus.STATUS_COMPLETED);
                                _this.H = setTimeout(_this.timer_H.bind(_this), Timers.TIMER_H);
                                resolve();
...
export { InviteServerTransaction };
/**
 * @function
 * @param {SIP.UA} ua
 * @param {SIP.IncomingRequest} request
 ...
 *  _false_ new request
 */
export function checkTransaction(ua, request) {
